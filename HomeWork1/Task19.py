...
TARGET_LLEFT_У = 250 # Левая нижняя координата у цели.
...
# Снаряд поразил цель?
if (turtle.xcor() >= TARGET_LLEFT_Х and turtle.xcor() <= (TARGET_LLEFT_Х + TARGET_WIDTH) and turtle.ycor() >= TARGET_LLEFT_У and turtle.ycor() <= (TARGET_LLEFT_У + TARGET_WIDTH)):
    print('Цель поражена! ')
else:
    print('Вы промахнулись. ')
    if turtle.xcor() < TARGET_LLEFT_Х:
        print('Уменьшите угол!')
    elif turtle.ycor() >= TARGET_LLEFT_У
